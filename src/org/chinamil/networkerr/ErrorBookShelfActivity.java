	   ...
	   /**
		...
		inflate.setOnItemClickListener(new OnItemClickListener() {
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        view.startAnimation(AnimationUtils.makeOutAnimation(ErrorBookShelfActivity.this,true));
				...
				/*inflate.setOnItemLongClickListener(new OnItemLongClickListener( ) {
                            public boolean onItemLongClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                                inflate.setOnTouchListener(ErrorBookShelfActivity.this);
                                inflate.setTag("zhuce");
                                return true;
                            }
                });*/
		   inflate.setTag("no");
				inflate.setAdapter(new Myarrayadapter(ErrorBookShelfActivity.this, inflate.getId(), dataHashMap.get(i)));
