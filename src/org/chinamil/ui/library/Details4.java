...
public class Details4 extends Activity implements OnClickListener {
   ...
   // private ImageGetter imageGetter;
    ...
    String dateString;
    String[] clounm = new String[] {
            Heibai.PUBLIC, Heibai.CONTENT,
    ...
    private boolean getData(String dString) {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            while (mergeCursor.moveToNext()) {
                ...
                // 缓存不行 只加载一次不行
                setViewData(mergeCursor.getString(1));
            }
            return true;
        } else
            return false;
    ...
    private void setViewData(String context) {
        ...
        ImageButton backButton = (ImageButton) headView.findViewById(R.id.btn_back);
        ...
        mListView.setAdapter(new LIstviewAdaoter(context));
    ...
    private class LIstviewAdaoter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (position==0) {
                ...
                Gallery gallery=new Gallery(Details4.this);
            ...
            mconvertView.setText(Html.fromHtml(text));
            return mconvertView;
            }
        }
    }
        ...
        switch (v.getId()) {
            case R.id.html_big_button2:
                if (textsize <= 30F) {
                    ...
                    TextView view = (TextView) listView.getChildAt(1);
            ...
            case R.id.html_shears:
				...
				.getItem(flipView.getSelectedItemPosition());
		ListView listView = (ListView) ss.findViewById(R.id.html2_listview);
	String context=(String) listView.getAdapter()
		.getItem(0);
...
System.out.println(context);
		...
		Toast.makeText(Details4.this, "已成功裁剪", 1).show();
            	/*
                View ss = (View) adapter
                        .getItem(flipView.getSelectedItemPosition());
                ListView listView = (ListView) ss.findViewById(R.id.html2_listview);
 ...
 */
    ...
    ArrayList<String>urlArrayList;boolean ismore;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            if (ismore) {//有多张的话 统一 大小
                ...
                text.setImageBitmap(Tools.resizeBitmap(urlArrayList.get(position), 400, 200));
          }else{//单张的话 显示原始大小
              text.setImageBitmap(BitmapFactory.decodeStream(new FileInputStream( urlArrayList.get(position))));// 这个可能会快点
          } 
