...
public class AesZipFileDecrypter implements ZipConstants {
	...
	private static final Logger LOG = Logger.getLogger( 
			AesZipFileDecrypter.class.getName() );
	...
	public void extractEntryWithTmpFile( ExtZipEntry zipEntry, File outFile, 
			String password ) throws IOException, ZipException, DataFormatException {
